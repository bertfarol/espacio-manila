  ...
  return (
    ...
    >
      <div className=" pb-16 md:px-5 md:pt-16 lg:py-32 2xl:pt-40 2xl:pb-28 bg-[#0C0C0C] before:absolute before:bg-[url('/blur-circle-white.png')] lg:before:h-[665px] before:w-[665px] before:left-[-300px] before:top-[-170px] before:bg-cover overflow-hidden">
        <div className="max-w-6xl 2xl:max-w-[1400px] mx-auto w-full lg:flex xl:items-end relative after:absolute after:bg-[url('/blur-circle-white.png')] 3xl:after:h-[665px] after:w-[665px] after:right-96 after:top-0 after:bg-cover">
          ...
          <div className="px-5 lg:px-0 lg:max-w-[424px]">
            ...
            <p className="text-white/80 lg:leading-relaxed">
              ...
              is readily available or as the seemingly boundless extent outside
              of our known world. We see Espacio Manila as a merged state of
              both definitions; the singular middle-ground that is available to
              those who wish to explore their boundless potential. A blank slate
              for the artwork and its artist, it will be a testament to the
              profound relations between art and the human race.
            </p>
          </div>
        </div>
      </div>
